...
async def load_tiles(info, z=-1, outfile=None, quality=90):
    ...
    img.save(os.path.join(outdir, final_image_filename), quality=quality, subsampling=0)
    shutil.rmtree(tiles_dir)
    print("Saved the result as " + final_image_filename)


def main(url='', zoom=1, command = True):
    ...
    coro = load_tiles(image_info, zoom, outfile, quality)
